...
public class HighActivity extends AppCompatActivity {
    ...
    private static final Categoria CATEGORIA = Categoria.HIGIENE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                Intent intent = new Intent(HighActivity.this, MainActivity.class);
    ...
    private void carregarProdutos() {
        ...
        new Thread(() -> {
            ...
            runOnUiThread(() -> {
                ...
                Toast.makeText(HighActivity.this, "Qtd: " + produtos.size(), Toast.LENGTH_SHORT).show();
            });
        }).start();
    }
}
