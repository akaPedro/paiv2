...
public class AlimActivity extends AppCompatActivity {

    private static final Categoria CATEGORIA = Categoria.ALIMENTOS;
...
//        observarProdutos();
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                Intent intent = new Intent(AlimActivity.this, MainActivity.class);
    ...
    private void carregarProdutos() {
        ...
        new Thread(() -> {
            ...
            runOnUiThread(() -> {
                ...
                Toast.makeText(AlimActivity.this, "Qtd: " + produtos.size(), Toast.LENGTH_SHORT).show();
            });
        }).start();
    }
