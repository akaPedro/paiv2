...
public class DoceActivity extends AppCompatActivity {
    ...
    private static final Categoria CATEGORIA = Categoria.DOCES;
...
//        observarProdutos();
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                Intent intent = new Intent(DoceActivity.this, MainActivity.class);
    ...
    private void carregarProdutos() {
        ...
        new Thread(() -> {
            ...
            runOnUiThread(() -> {
                ...
                Toast.makeText(DoceActivity.this, "Qtd: " + produtos.size(), Toast.LENGTH_SHORT).show();
            });
        }).start();
    }
